function [tspan,Y] = ode2(odefun,tspan,y0,options,varargin)
%ODE2  Solve differential equations with a non-adaptive method of order 2.
%      This is a variant of the unofficial fixed step size 2nd-order Euler integrator
...
%
%   Y = ODE2(ODEFUN,TSPAN,Y0,OPTIONS,P1,P2...) passes the additional parameters 
