function [tspan,Y] = ode3(odefun,tspan,y0,options,varargin)
%ODE3  Solve differential equations with a non-adaptive method of order 3.
%      This is a variant of the unofficial fixed step size RK3 integrator
...
%
%   Y = ODE3(ODEFUN,TSPAN,Y0,OPTIONS,P1,P2...) passes the additional parameters 
