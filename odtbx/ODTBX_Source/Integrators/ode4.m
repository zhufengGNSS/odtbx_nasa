function [tspan,Y] = ode4(odefun,tspan,y0,options,varargin)
%ODE4  Solve differential equations with a non-adaptive method of order 4.
%      This is a variant of the unofficial fixed step size RK4 integrator
...
%
%   Y = ODE4(ODEFUN,TSPAN,Y0,OPTIONS,P1,P2...) passes the additional parameters 
