function [tspan,Y] = ode5(odefun,tspan,y0,options,varargin)
%ODE5  Solve differential equations with a non-adaptive method of order 5.
%      This is a variant of the unofficial fixed step size RK5 integrator
...
%
%   Y = ODE5(ODEFUN,TSPAN,Y0,OPTIONS,P1,P2...) passes the additional parameters 
