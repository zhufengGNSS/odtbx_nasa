...
%
% jatWorldPropagatorRK8 only works with the JAT force models and is 
...
%
%   keyword: integrator
%   See also jatWorldPropagatorRK4, jatWorldPropagatorRKF78, JATFORCES, 
%   CREATEJATWORLD
%
...
%   Allen Brown         02/10/2009      Renamed to jatWorldPropagatorRK8

if nargin < 8
    error('MATLAB:jatWorldPropagatorRK8:NotEnoughInputs',...
...
if( ~isjava(jatWorld) || ...
    ...
    error('MATLAB:jatWorldPropagatorRK8:NoJATObject An ODToolboxJATModel object must be the eighth input.');
end

stepSize = odeget(odeSolverOptions,'InitialStep',1.0);

% Now do integrator stuff...
jatStates = jat.matlabInterface.ODToolboxIntegrators.RK8(tspan,y0,stepSize,jatWorld);
