function y = mJD2MatlabTime(time)

% MJD2MATLABTIME  Returns the datenum of the input Modified Julian Date
%
%   y = mJD2MatlabTime(time) returns the datenum of the input Modified
%   Julian Date. This function is used to enable a common time interface
%   with the JAT adapters.
%
%   INPUTS 
%   VARIABLE    SIZE    	DESCRIPTION (Optional/Default)
%     time      (1Xn)       Vector of Modified Julian dates.
%
%   OUTPUTS 
