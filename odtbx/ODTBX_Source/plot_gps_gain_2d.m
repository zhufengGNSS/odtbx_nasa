function [h] = plot_gps_gain_2d(ant, gain, PRN)
% Plots the gain from gps_gain vs azimuth and elevation angles (2D plots).
%
%   INPUTS
%   VARIABLE        TYPE    SIZE    DESCRIPTION (Optional/Default)
%   ant             double  1       provided antenna data is: 1=receive, 
%                                   2=transmit
%   gain            double  4xN     (1,:) time, UTC epoch of the measurement,
