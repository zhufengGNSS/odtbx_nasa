function failed = jatWorldPropagatorRK4_test()
% Regression Test Case
% Function(s) jatWorldPropagatorRK4, jatForces, createJatWorld
%
...
failed      = 0;
tol         = 1e-6;
integrator  = @jatWorldPropagatorRK4;
...
% save jatWorldPropagatorRK4RegressionBaseline.mat xPlot

xPlotTest = xPlot/1000;  % convert back to km for comparisons

load jatWorldPropagatorRK4RegressionBaseline
