function failed = LOSDoppler_test()
%
% LOSDoppler_test Regression test for LOSDoppler
% See also: LOSDoppler.m
%
...
%   Author      		Date         	Comment
%
%   Ravi Mathur         08/28/2012      Extracted from LOSDoppler.m
...
Doppler = LOSDoppler(t, r1, v1, r2, v2, options);
