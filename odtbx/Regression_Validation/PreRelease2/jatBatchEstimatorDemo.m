% Pre-Release R2 Batch Estimator Demo using JAT Force Models
% Function jatBatchEstimatorDemo: Basic Validation Test Case
%   based on estbat_r2baseline
%
%    Models:
%        Dynamics: jatForces (2-body gravity)
...
function [failed,elapsedTime] = jatBatchEstimatorDemo;
testCaseName = 'jatBatchEstimatorDemo';
format long;
...
jOptions = jatForcesDemoOptions();
jatWorld = createJATWorld(jOptions); 

% Run the batch filter:
[t,xhat,P,e,dy]=estbat(@jatForces_km, @rrdot3D,tspan,x0,P0,opts,jatWorld,sig);  
