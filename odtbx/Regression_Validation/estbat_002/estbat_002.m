...
% estbat_002: UpdateIterations increased from 1 to 3
%    Models:
%        Dynamics: r2bp.m
...
function [failed] = estbat_002;
cd estbat_002
testCaseName = 'estbat_002';
format long
...
opts = setOdtbxOptions('UpdateIterations',3,'MonteCarloCases',1,...
    'ValidationCase', 1,...
...
% save covariance_baseline_estbat_002.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
% failed = 0;
