...
% estseq_003: Using Monte Carlo Seed
%    Models:
%        Dynamics: r2bp.m
...
function [failed] = estseq_003
cd estseq_003
testCaseName = 'estseq_003';
format long
...
opts = setOdtbxOptions('UpdateIterations',1,'MonteCarloCases',3,...
    'ValidationCase',...
    1,'OdeSolvOpts',odeset('Vectorized','on','InitialStep',10));
...
%  save covariance_baseline_estseq_003.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
%  failed = 0;
