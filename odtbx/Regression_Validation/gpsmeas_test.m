...
%                           1 if one of the test cases failed.
    ...
    measOptions.('useRangeRate')      = true;
    measOptions.('useDoppler')        = false;
    ...
    measOptions.('AntennaPointing')   = ant_point;                        % override of truth.pointing_ref
    measOptions.('AntennaPattern')    = eval(ant_pat);
    ...
    measOptions.('GPSBlock')          = truth.sv_block;                   % enum
