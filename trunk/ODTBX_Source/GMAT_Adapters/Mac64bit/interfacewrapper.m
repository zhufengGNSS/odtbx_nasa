...
%This function was generated by loadlibrary.m parser version 1.1.6.34 on Mon Aug 29 16:21:59 2011
%perl options:'CInterfaceFunctions.i -outfile=interfacewrapper.m -thunkfile=libCInterface_thunk_maci64.c -header=CInterfaceFunctions.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'libCInterface_thunk_maci64');
