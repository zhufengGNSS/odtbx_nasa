...
%This function was generated by loadlibrary.m parser version 1.1.6.34 on Mon Aug 29 16:40:20 2011
%perl options:'CInterfaceFunctions.i -outfile=interfacewrapper.m'
...
fcns.name{fcnNum}='SetModel'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32'};fcnNum=fcnNum+1;
% int SetModelByName ( const char * modelName ); 
fcns.name{fcnNum}='SetModelByName'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'cstring'};fcnNum=fcnNum+1;
% int GetStateSize (); 
