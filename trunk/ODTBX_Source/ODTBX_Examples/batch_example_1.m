% Example for the ODTBX Batch Estimator, estbat.m, using range and range rate measurements.
%
...
tspan = 0:10:300;
%
% Set some options for the batch filter.  We will run 30 Monte Carlo cases 
...
%
tic
[t,xhat,P,e,dy,Pa,Pv,Pw,Phata,Phatv,Phatw,SigSA,Pdy,Pdyt]=estbat(...
