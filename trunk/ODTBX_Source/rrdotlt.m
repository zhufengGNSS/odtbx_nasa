...
if strcmpi(t1,'ValidationTest')||strcmpi(t1,'RegressionTest')
    y = rrdotlt_validation_test();  
else
	[y,H,R,t2_lt,x2_lt] = Get_rrdotlt(t1,x1,t2,x2,options);
end
end

%% Main function
function [y,H,R,t2_lt,x2_lt] = Get_rrdotlt(t1,x1,t2,x2,options)
...
function failed = rrdotlt_validation_test()
...
y = Get_rrdotlt(t,x1,t,x2,options);
