function fail = FilterEstCnoThresh_test()
...
%% TEST 1 - constructor
TESTNUM = 1;
fprintf(1,'\nExecuting FilterEstCnoThresh test %d:\n\n',TESTNUM);
...
dat.meta.RX_meta.meas_file = 'FilterEstCnoThresh.m';
dat.meta.RX_meta.obs_metadata{1} = '1';
dat.meta.RX_meta.obs_metadata{2} = '2';
dat.meta.RX_state_source = 'FilterEstCnoThresh.m';
dat.meta.TX_ID = makeGpsTXID(123, 13, 1); % ID 123, PRN 13, block II
dat.meta.TX_state_source = 'FilterEstCnoThresh.m';
...
gdat.RX_meta.meas_file = 'FilterEstCnoThresh.m';
