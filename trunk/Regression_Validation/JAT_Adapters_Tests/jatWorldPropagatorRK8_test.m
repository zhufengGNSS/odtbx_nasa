function failed = jatWorldPropagatorRK8_test()
% Regression Test Case
% Function(s) jatWorldPropagatorRK8, jatForces, createJatWorld
%
...
failed      = 0;
tol         = 1e-6;
integrator  = @jatWorldPropagatorRK8;
...
% To save data for regression testing check:
% save jatWorldPropagatorRK8RegressionBaseline.mat xPlot

xPlotTest = xPlot/1000;  % convert back to km for comparisons

load jatWorldPropagatorRK8RegressionBaseline
