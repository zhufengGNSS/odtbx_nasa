...
% estbat_003: Increased Monte Carlo cases from 1 to 3
%    Models:
%        Dynamics: r2bp.m
...
%    Options:
%        integrator: ode45
%            odeset('Vectorized','on','MaxStep',60) sec
%        DatVectorized: off
%        DatJtolerance: N/A
%        DatJpattern: N/A
%        UpdateIterations: 1
...
function [failed] = estbat_003;
cd estbat_003
testCaseName = 'estbat_003';
format long
...
tspan = [0:60:43200]; %Measurement step size and the length of the run are set here
...
opts = setOdtbxOptions('UpdateIterations',1,'MonteCarloCases',3,...
    'ValidationCase', 1,...
    'OdeSolvOpts',odeset('Vectorized','on','InitialStep',60));
...
% save covariance_baseline_estbat_003.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
% failed = 0;
