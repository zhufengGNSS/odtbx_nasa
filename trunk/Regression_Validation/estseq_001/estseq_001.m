...
% estseq_001: Basic estseq validation case
%    Models:
%        Dynamics: r2bp.m
...
function [failed] = estseq_001
cd estseq_001
testCaseName = 'estseq_001';
format long
...
%  save covariance_baseline_estseq_001.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
 % failed = 0;
