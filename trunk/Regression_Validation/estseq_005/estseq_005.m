...
% estseq_005: Changed EditFlag to Force and EditRatio to vector option
% (NOTE: EditFlag and EditRatio have been removed as options)
%    Models:
%        Dynamics: r2bp.m
...
function [failed] = estseq_005
cd estseq_005
testCaseName = 'estseq_005';
format long
...
%  save covariance_baseline_estseq_005.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
%  failed = 0;
