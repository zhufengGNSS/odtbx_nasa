...
% estseq_006: Changed to UpdateIterations vector option
%    Models:
%        Dynamics: r2bp.m
...
function [failed] = estseq_006
cd estseq_006
testCaseName = 'estseq_006';
format long
...
opts = setOdtbxOptions('UpdateIterations',[1,2],'MonteCarloCases',1,...
    'ValidationCase', 1,'OdeSolvOpts',odeset('Vectorized','on','InitialStep',10));
...
%  save covariance_baseline_estseq_006.mat ODTBX_Covariance_Time_Zero ODTBX_Covariance_Time_Last
%  failed = 0;
