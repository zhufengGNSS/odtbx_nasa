...
public class SimpleEOM implements Derivatives {
	...
	public double[] derivs(double t, double[] y) {
		...
		// DE405 returns meters
		VectorN r_moon = new VectorN(jpl_ephem.get_planet_pos(DE405_Body.GEOCENTRIC_MOON, tt.mjd_tt()));
        ...
        // DE405 returns meters
		VectorN r_sun = new VectorN(jpl_ephem.get_planet_pos(DE405_Body.GEOCENTRIC_SUN, tt.mjd_tt()));
        d0 = r0.minus(r_sun);
