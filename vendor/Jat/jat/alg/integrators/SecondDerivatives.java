...
/**
 * <P>
 * The SecondDerivatives interface provides the mechanism for passing a method
 * that computes the derivatives to an integrator.
 *
 * @author <a href="mailto:dave.gaylor@emergentspace.com">Dave Gaylor
 * @version 1.0
 */
public interface SecondDerivatives {

    /** Compute the derivatives.
     * @params t    double containing time or the independent variable.
     * @params x    VectorN containing the required data.
     * @params xdot VectorN containing the first derivatives.
     * @return      double [] containing the second derivatives.
     */
