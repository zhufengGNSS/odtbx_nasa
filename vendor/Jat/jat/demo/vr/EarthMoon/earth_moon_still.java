 ...
 *
 */
public class earth_moon_still extends Applet implements ActionListener
{
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public earth_moon_still()
	{
		// Get path of this class, frames will be saved in subdirectory frames
		String b = FileUtil.getClassFilePath("jat.demo.vr.EarthMoon", "earth_moon_still");
		...
		TG_scene.addChild(apollo = new ThreeDStudioObject(this, "Apollo/Apollo13.3ds", 1.f));
		...
		/*
		TextureLoader tex1 = new TextureLoader(b +"stars3.jpg", this);
		TextureLoader tex2 = new TextureLoader(b +"Panorama.jpg", this);
		//Node pan1=new Panorama3D(3000000.f, 20000000.f, tex1.getTexture());
		Panorama3D pan1=new Panorama3D(3000000.f, 10000000.f, tex1.getTexture());
		Panorama3D pan2=new Panorama3D(3000000.f, 10000000.f, tex1.getTexture());	
		//placeObject(new Panorama(1000f, 400f, tex.getTexture()),75.f, -100.f, -75.f, 0.f);
		BG_root.addChild(pan1);
		BG_root.addChild(pan2);
		pan2.set_attitude(0,0,Math.PI);
		*/
		...
		/*
		private final void placeObject(Node object, float x, float y, float z)
		{
			Transform3D xform = new Transform3D();
			xform.set(new Vector3f(x, y, z));
		...
		*/
		...
		BG_vp = jat_view.view(500000, 0., 0000., c);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (i < 1999)
		{
			...
			//spacecraft.set_position(tra.coords[i * 3 + 0], tra.coords[i * 3 + 1], tra.coords[i * 3 + 2]);
		}
...
//		jat_view.set_view_position(V_view.x, V_view.y, V_view.z);
	...
	{
		earth_moon_still em = new earth_moon_still(); // Applet
