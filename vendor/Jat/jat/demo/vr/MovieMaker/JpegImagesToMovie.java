...
//-w 320 -h 240 -f 1 -o abc.mov 1.jpg 2.jpg
/*
...
package jat.demo.vr.MovieMaker;
...
public class JpegImagesToMovie implements ControllerListener, DataSinkListener
{
    ...
    public static void main(String args[])
    {
	    ...
	    String outputURL = "abc.mov";

        for(i=0;i<8;i++)
	        inputFiles.addElement(frames_path+"Capture"+i+".jpg");
	        //inputFiles.addElement(frames_path+"Capture1.jpg");
        ...
        */
	    ...
	    //if (outputURL == null || inputFiles.size() == 0)   prUsage();
