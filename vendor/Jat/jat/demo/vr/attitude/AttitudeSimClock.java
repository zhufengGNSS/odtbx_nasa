...
public class AttitudeSimClock extends Applet implements ActionListener
{
	BranchGroup BG_root;
	BranchGroup BG_vp;
	...
	public AttitudeSimClock()
	{
		...
		// Animation
		int DeltaT = (int) (time_step / 0.001); // Convert time_step(sec) to miliseconds 
		SimulationClock SimClock = new SimulationClock(this, DeltaT, panel, numberOfPts, quat_values);
	...
	{
		AttitudeSimClock at = new AttitudeSimClock(); // Applet
