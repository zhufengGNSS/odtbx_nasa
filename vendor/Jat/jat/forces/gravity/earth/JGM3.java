...
import jat.forces.gravity.SphericalHarmonicGravity;
...
public class JGM3 extends SphericalHarmonicGravity {
    ...
    public static void main(java.lang.String args[]){
        ...
        double mu = jgm3.getGM();
        VectorN r = new VectorN(6378135.0, 0.0, 0.0);
        double rmag = r.mag();
        double muor3 = -1.0*mu/(rmag*rmag*rmag);
        VectorN grav = r.times(muor3);
        grav.print("gravity");
        VectorN jgm3grav = jgm3.bodyFixedGravity(r);
        jgm3grav.print("jgm3grav");
    }
