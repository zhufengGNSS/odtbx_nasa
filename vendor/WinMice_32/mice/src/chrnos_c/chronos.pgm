...
/* Main program */ MAIN__(void)
{
    ...
    char outtim[256], tofrmt[256], setpfn[256], censtr[32], curkey[32], 
	    fromts[32], fromtt[32], lsttim[32], solids[32], systms[32*4];
    ...
    extern /* Subroutine */ int errprt_(char *, char *, ftnlen, ftnlen), 
	    ...
	    integer *, char *, logical *, char *, logical *, ftnlen, ftnlen, 
	    ftnlen), dsplay_(char *, char *, ftnlen, ftnlen), spekon_(void), 
	    ...
	    , integer *, logical *, ftnlen), intstr_(integer *, char *, 
	    ftnlen), dtpool_(char *, logical *, integer *, char *, ftnlen, 
	    ftnlen), spekst_(char *, ftnlen);
    char hwd[32];
    extern /* Subroutine */ int ktotal_(char *, integer *, ftnlen), cronos_(
	    char *, integer *, char *, char *, ftnlen, ftnlen, ftnlen), 
	    tostdo_(char *, ftnlen), chkout_(char *, ftnlen), byebye_(char *, 
	    ftnlen);
    integer ptr;
...
/*     Parse command line. */
    ...
    parcml_(hline, &c__19, clkeys, clflag, clvals, &found, (ftnlen)2048, (
...
/*     present? Display USAGE and STOP if yes. */
    ...
    if (! found || clflag[(i__1 = isrchc_("-USAGE", &c__19, clkeys, (ftnlen)6,
	    ...
	    i__1, "chronos_", (ftnlen)354)] || clflag[(i__2 = isrchc_("-U", &
	    c__19, clkeys, (ftnlen)2, (ftnlen)32) - 1) < 19 && 0 <= i__2 ? 
	    i__2 : s_rnge("clflag", i__2, "chronos_", (ftnlen)354)]) {
...
/*     Are there any help keys? Display HELP and STOP if yes. */
    ...
    if (clflag[(i__1 = isrchc_("-HELP", &c__19, clkeys, (ftnlen)5, (ftnlen)32)
	    ...
	    , (ftnlen)365)] || clflag[(i__2 = isrchc_("-H", &c__19, clkeys, (
	    ftnlen)2, (ftnlen)32) - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge(
	    "clflag", i__2, "chronos_", (ftnlen)365)]) {
...
/*     But first, let set all values to blanks. */
	...
	if (clflag[(i__1 = i__ - 1) < 19 && 0 <= i__1 ? i__1 : s_rnge("clflag"
		, i__1, "chronos_", (ftnlen)425)]) {
	    s_copy(curkey, clkeys + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ? 
		    i__1 : s_rnge("clkeys", i__1, "chronos_", (ftnlen)427)) <<
...
/*              It's a setup file name. */
		...
		s_copy(setpfn, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ?
			...
			433)) << 11), (ftnlen)256, rtrim_(clvals + (((i__2 = 
			i__ - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", 
			i__2, "chronos_", (ftnlen)433)) << 11), (ftnlen)2048))
			;
...
/*              It's "from" time system. */
		...
		s_copy(fromts, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ?
			 i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)
			439)) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = 
			i__ - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", 
...
/*              It's "from" time type. */
		...
		s_copy(fromtt, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ?
			 i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)
			446)) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = 
			i__ - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", 
			i__2, "chronos_", (ftnlen)446)) << 11), (ftnlen)2048))
			;
...
/*              It's "to" time system. */
		...
		s_copy(tots, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)453)
			) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = i__ - 
			1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", i__2, 
			"chronos_", (ftnlen)453)) << 11), (ftnlen)2048));
...
/*              It's "to" time type. */
		...
		s_copy(tott, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)460)
			) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = i__ - 
			1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", i__2, 
			"chronos_", (ftnlen)460)) << 11), (ftnlen)2048));
...
/*              It's "to" time format. */
		...
		s_copy(tofrmt, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ?
			 i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)
			467)) << 11), (ftnlen)256, rtrim_(clvals + (((i__2 = 
			i__ - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", 
			i__2, "chronos_", (ftnlen)467)) << 11), (ftnlen)2048))
			;
...
/*              It's spacecraft ID; save it in string. */
		...
		s_copy(scstr, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)479)
			) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = i__ - 
			1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", i__2, 
			"chronos_", (ftnlen)479)) << 11), (ftnlen)2048));
...
/*              It's body ID; save it in string. */
		...
		s_copy(censtr, clvals + (((i__1 = i__ - 1) < 19 && 0 <= i__1 ?
			 i__1 : s_rnge("clvals", i__1, "chronos_", (ftnlen)
			485)) << 11), (ftnlen)32, rtrim_(clvals + (((i__2 = 
			i__ - 1) < 19 && 0 <= i__2 ? i__2 : s_rnge("clvals", 
			i__2, "chronos_", (ftnlen)485)) << 11), (ftnlen)2048))
			;
...
/*     "FROM" time type goes third. */
	...
	if (! systyp[(i__1 = frsidx + (frtidx << 2) - 5) < 40 && 0 <= i__1 ? 
		i__1 : s_rnge("systyp", i__1, "chronos_", (ftnlen)562)]) {
...
/*           value that we have got is blank. */
	    ...
	    s_copy(fromtt, deftyp + (((i__1 = frsidx - 1) < 4 && 0 <= i__1 ? 
		    i__1 : s_rnge("deftyp", i__1, "chronos_", (ftnlen)582)) <<
		     5), (ftnlen)32, (ftnlen)32);
	    frtidx = isrchc_(fromtt, &c__10, types, (ftnlen)32, (ftnlen)32);
	}
    }
...
/*     "TO" time type goes fourth. */
	...
	if (! systyp[(i__1 = tosidx + (totidx << 2) - 5) < 40 && 0 <= i__1 ? 
		i__1 : s_rnge("systyp", i__1, "chronos_", (ftnlen)592)]) {
...
/*           that we have got is blank. */
	    ...
	    s_copy(tott, deftyp + (((i__1 = tosidx - 1) < 4 && 0 <= i__1 ? 
		    i__1 : s_rnge("deftyp", i__1, "chronos_", (ftnlen)612)) <<
		     5), (ftnlen)32, (ftnlen)32);
	    totidx = isrchc_(tott, &c__10, types, (ftnlen)32, (ftnlen)32);
	}
    }
...
/* Writing concatenation */
	i__6[0] = rtrim_(systms + (((i__2 = tosidx - 1) < 4 && 0 <= i__2 ? 
		i__2 : s_rnge("systms", i__2, "chronos_", (ftnlen)699)) << 5),
	...
	i__6[2] = rtrim_(types + (((i__5 = totidx - 1) < 10 && 0 <= i__5 ? 
		i__5 : s_rnge("types", i__5, "chronos_", (ftnlen)699)) << 5), 
