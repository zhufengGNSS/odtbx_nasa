%-Abstract
%
%   CSPICE_B1950 returns the double precision value of the Julian Date
...
%   returns:
%   
%     A double precision scalar, 2433282.42345905, the Julian Date 
...
function [b1950] = cspice_b1950
   ...
   switch nargin
      ...
      otherwise
         ...
         error ( 'Usage: double = cspice_b1950' )
