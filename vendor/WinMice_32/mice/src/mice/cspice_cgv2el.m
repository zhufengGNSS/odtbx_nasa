%-Abstract
%
%   CSPICE_CGV2EL forms a Mice ellipse from a center vector and two generating 
%   vectors. 
%   
%-Disclaimer
%
...
%   Given:
%
%      center   double precision 3x1 array defining the location for 
%               an ellipse center 
%
%      vec1 & 
%      vec2     the two double precision 3x1 arrays defining the ellipse 
...
%   returns:
%
%      ellipse   a structure describing a Mice ellipse defined by the input 
...
%-Particulars
%
%   Mice ellipses serve to simplify calling sequences and reduce 
