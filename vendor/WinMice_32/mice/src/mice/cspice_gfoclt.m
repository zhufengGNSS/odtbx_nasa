...
%      Arguments-
%
%      occtyp   the string scalar naming the type of occultation to find.
...
%               the string 'occtyp'.
% 
%      front    the string scalar naming the target body that occults---that 
...
%               and trailing blanks.
% 
%      fshape   the string scalar naming the geometric model used 
...
% 
% 
%      fframe   the string scalar naming the body-fixed, body-centered 
...
%               and trailing blanks.
% 
%      back     the string scalar naming the target body that is occulted 
...
%                details.
% 
%      bframe   the string scalar naming the body-fixed, body-centered 
