...
%               an instrument. 
% 
%      raydir   a double precision 3x1 array describing a ray pointing
...
%               the search. 'step' must be short enough for a search using 
%               step to locate the time intervals where the specified
