...
%               measure (N) as 'et'.
%
%      cspice_spkezr also accepts the string form of the integer NAIF IDs 
...
%      %
%      [state , ltime] = cspice_spkezr( target, vec_et, ...
...
function [state, lt] = cspice_spkezr(targ, et, ref, abcorr, obs)
