...
%   Given:
%
%      v1   {3x1 ARRAY or 3xN ARRAY, DOUBLE PRECISION}
%
%   the call:
%
...
%   returns:
%
%      vout   {3x1 ARRAY or 3xN ARRAY, DOUBLE PRECISION} unit vector(s) 
%             in the direction of 'v1'. If 'v1' represents the zero vector,
%             then 'vout' will also be the zero vector.
%
%      vmag   {SCALAR or 1xN ARRAY, DOUBLE PRECISION} magnitude(s) of 'v1'
%
