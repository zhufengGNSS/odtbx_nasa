...
%   Given:
%
%      left     the double precision scalar amount to subtract 
%               from each left interval endpoint in the input 'window'
%
%      right    the double precision scalar amount to add
%               to each right interval endpoint in the input 'window' 
%
...
%                 of a SPICE window, containing zero or more intervals,
%                 representing the original 'window' with each of its 
