...
%   Given:
%
%      side     the string scalar indicating whether to extract the 
%               left or right endpoints of the intervals in 'window'
%
%                 'L', 'l'       Left endpoints. 
%                 'R', 'r'       Right endpoints.
%
...
%               of a SPICE window, containing zero or more intervals,
%               representing the collection of singleton intervals 
