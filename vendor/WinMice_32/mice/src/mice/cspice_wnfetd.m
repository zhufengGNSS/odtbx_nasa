...
%
%      n        the integer scalar index of a particular interval within the 
%               window.  Indices range from 1 to N, where N is the
...
%
%      left, 
%      right   two scalar double precision values defining the left and right 
%              endpoints of the nth interval in the input 'window'
%
%-Examples
%
