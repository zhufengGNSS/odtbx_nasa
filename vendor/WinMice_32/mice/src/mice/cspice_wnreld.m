...
%
%      a, 
%      b    two double precision arrays (Lx1, Mx1) serving as 
%           the Mice version of SPICE windows, containing zero or 
%           more intervals   
%   
%      op   the scalar string comparison operator, indicating the way to 
%           compare the input windows. 'op' may have any of the 
%           following values: 
%   
%              Operator             Meaning 
%              --------  ------------------------------------- 
...
%-Version
%
%   -Mice Version 1.0.0, 23-JUL-2009, EDW (JPL)
%
