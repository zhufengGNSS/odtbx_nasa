...
%              define as a 1x2 array. When use, 'range' must
...
%      value of 'x' to within a close set.
%
   ...
   if( is_valid )
      ...
      switch nargin
         ...
         otherwise
            ...
            % for completeness. 
            %
            error( ['MICE(BUG): This instruction should not execute, ' ...
                     'indicating a bug. Please contact NAIF.'] )   
