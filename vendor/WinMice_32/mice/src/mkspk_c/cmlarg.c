...
/*                 existing output file was requested. If approprite */
...
/*     in the include file. */
	...
	for (i__ = 1; i__ <= 18; ++i__) {
	    tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
		    s_rnge("messge", i__2, "cmlarg_", (ftnlen)320)) * 80, (
		    ftnlen)80);
	}
	s_stop("", (ftnlen)0);
    }
...
/*     in the include file. */
	...
	for (i__ = 1; i__ <= 27; ++i__) {
	    tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
		    s_rnge("messge", i__2, "cmlarg_", (ftnlen)387)) * 80, (
		    ftnlen)80);
	}
	s_stop("", (ftnlen)0);
    }
...
/*        specific template will be displayed. */
	...
	s_copy(messge + 480, "   OBJECT_ID         = NAIF numeric code of th"
		"e object or NORAD s/c code", (ftnlen)80, (ftnlen)72);
...
/*           template displays. */
		...
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)517)) * 80, 
			(ftnlen)80);
	    }
	    s_stop("", (ftnlen)0);
	} else {
...
/*        type. */
	...
	if (ioutyp != 5 && ioutyp != 8 && ioutyp != 9 && ioutyp != 10 && 
		...
		{
	    setmsg_("Output SPK type '#' prodived on the command line is not"
...
/*           Input type is STATES, output type is 5. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)624)) * 80, 
			(ftnlen)80);
	    }
...
/*           Input type is STATES, output type is 8. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)637)) * 80, 
			(ftnlen)80);
	    }
...
/*           Input type is STATES, output type is 9. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)650)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	} else if (eqstr_(inptyp, "STATES", (ftnlen)11, (ftnlen)6) && ioutyp 
...
/*           Input type is STATES, output type is 12. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)663)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	} else if (eqstr_(inptyp, "STATES", (ftnlen)11, (ftnlen)6) && ioutyp 
...
/*           Input type is STATES, output type is 13. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)676)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	} else if (eqstr_(inptyp, "STATES", (ftnlen)11, (ftnlen)6) && ioutyp 
...
/*           Input type is STATES, output type is 15. */
		...
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)687)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 35; i__ <= 39; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)691)) * 80, 
			(ftnlen)80);
	    }
	} else if (eqstr_(inptyp, "STATES", (ftnlen)11, (ftnlen)6) && ioutyp 
		== 17) {
...
/*           Input type is STATES, output type is 17. */
		...
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)700)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 35; i__ <= 37; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)704)) * 80, 
			(ftnlen)80);
	    }
...
/*           Input type is ELEMENTS, output type is 5. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)713)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2720, (ftnlen)80);
	} else if (eqstr_(inptyp, "ELEMENTS", (ftnlen)11, (ftnlen)8) && 
...
/*           Input type is ELEMENTS, output type is 8. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)726)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	    tostdo_(messge + 2720, (ftnlen)80);
...
/*           Input type is ELEMENTS, output type is 9. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)740)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	    tostdo_(messge + 2720, (ftnlen)80);
...
/*           Input type is ELEMENTS, output type is 12. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)754)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	    tostdo_(messge + 2720, (ftnlen)80);
...
/*           Input type is ELEMENTS, output type is 13. */
	    ...
	    for (i__ = 1; i__ <= 27; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)768)) * 80, 
			(ftnlen)80);
	    }
	    tostdo_(messge + 2640, (ftnlen)80);
	    tostdo_(messge + 2720, (ftnlen)80);
...
/*           Input type is ELEMENTS, output type is 15. */
	    ...
	    for (i__ = 1; i__ <= 33; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)780)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 35; i__ <= 39; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)784)) * 80, 
			(ftnlen)80);
	    }
	} else if (eqstr_(inptyp, "ELEMENTS", (ftnlen)11, (ftnlen)8) && 
		ioutyp == 17) {
...
/*           Input type is ELEMENTS, output type is 17. */
	    ...
	    for (i__ = 1; i__ <= 29; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)793)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 35; i__ <= 37; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
...
/*           Input type is EQ_ELEMENTS, output type is 17. */
	    ...
	    for (i__ = 1; i__ <= 29; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)806)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 36; i__ <= 37; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)810)) * 80, 
			(ftnlen)80);
	    }
...
/*           Input type is TL_ELEMENTS, output type is 10. */
	    ...
	    s_copy(messge + 480, "   OBJECT_ID         = NORAD satellite cod"
		    "e ", (ftnlen)80, (ftnlen)44);
/* Writing concatenation */
...
/* Writing concatenation */
	    ...
	    for (i__ = 1; i__ <= 7; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)830)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 10; i__ <= 14; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)834)) * 80, 
			(ftnlen)80);
	    }
	    for (i__ = 17; i__ <= 20; ++i__) {
		tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
			s_rnge("messge", i__2, "cmlarg_", (ftnlen)838)) * 80, 
			(ftnlen)80);
	    }
...
/*        three lines of it and stop the program. */
	...
	for (i__ = 40; i__ <= 43; ++i__) {
	    tostdo_(messge + ((i__2 = i__ - 1) < 50 && 0 <= i__2 ? i__2 : 
		    s_rnge("messge", i__2, "cmlarg_", (ftnlen)862)) * 80, (
		    ftnlen)80);
	}
	s_stop("", (ftnlen)0);
    }
