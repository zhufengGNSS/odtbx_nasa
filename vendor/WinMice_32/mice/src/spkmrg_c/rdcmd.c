	...
	*cmdval, ftnlen cmdfil_len, ftnlen cmdsym_len, ftnlen cmdval_len)
{
    ...
    static char kwds1[32*2] = "LEAPSECONDS_KERNEL  1  1        " "SPK_KERNEL"
	    "          1  300      ";
    static char kwds2[32*5] = "SOURCE_SPK_KERNEL   1  300      " "LOG_FILE  "
	    "          0  1        " "BODIES              0  1        " "BEGI"
	    "N_TIME          0  300      " "INCLUDE_TEXT_FILE   0  300      ";
    static char kwds3[32*3] = "BODIES              0  1        " "BEGIN_TIME"
	    "          0  300      " "INCLUDE_COMMENTS    0  1        ";
...
/*     1) An error is signalled if the file cannot be parsed */
/*        successfully. */
...
/*     Open the command file, and parse its contents */
	...
	iostat = do_fio(&c__1, line, (ftnlen)120);
	if (iostat != 0) {
	    goto L100001;
	}
	iostat = e_rsfe();
L100001:
	eof = iostat != 0;
	evalcp_(line, &eof, cmdsym, cmdptr, cmdval, &err, (ftnlen)120, 
