...
/* Main program */ MAIN__(void)
{
    ...
    char ch__1[25013], ch__2[25033], ch__3[25020];
    ...
    extern /* Subroutine */ int zzckcvr3_(integer *, integer *, integer *, 
	    ...
	    doublereal *);
    static logical tdsp;
    static char type__[3], text[256*46], strn[256];
    static logical vrsn;
...
/*     The first thing we do is to display version. */
    ...
    s_copy(line, "CKBRIEF -- Version # -- Toolkit Version #", (ftnlen)256, (
	    ftnlen)41);
    tostdo_(" ", (ftnlen)1);
    repmc_(line, "#", "5.0.0, February 11, 2009", line, (ftnlen)256, (ftnlen)
	    1, (ftnlen)24, (ftnlen)256);
...
/*     Set up the help text. */
    ...
    s_copy(text + 6656, "      -g           display summary grouped by cover"
	    "age", (ftnlen)256, (ftnlen)54);
    s_copy(text + 6912, " ", (ftnlen)256, (ftnlen)1);
    s_copy(text + 7168, "      -utc         display times in UTC calendar da"
	    "te format", (ftnlen)256, (ftnlen)60);
    s_copy(text + 7424, "      -utcdoy      display times in UTC day-of-year"
	    " format", (ftnlen)256, (ftnlen)58);
    s_copy(text + 7680, "      -sclk        display times as SCLK strings", (
	    ftnlen)256, (ftnlen)48);
    s_copy(text + 7936, "      -dpsclk      display times as SCLK ticks", (
	    ftnlen)256, (ftnlen)46);
    s_copy(text + 8192, " ", (ftnlen)256, (ftnlen)1);
    s_copy(text + 8448, "      [ID]         display summary for structure wi"
	    "th [ID]", (ftnlen)256, (ftnlen)58);
    s_copy(text + 8704, " ", (ftnlen)256, (ftnlen)1);
    s_copy(text + 8960, "      -f [list]    summarize kernels listed in the "
	    "[list] file", (ftnlen)256, (ftnlen)62);
    s_copy(text + 9216, " ", (ftnlen)256, (ftnlen)1);
    s_copy(text + 9472, "      -h           display help", (ftnlen)256, (
	    ftnlen)31);
    s_copy(text + 9728, "      -v           display version", (ftnlen)256, (
	    ftnlen)34);
    s_copy(text + 9984, " ", (ftnlen)256, (ftnlen)1);
    s_copy(text + 10240, "   The options can be provided in any order and ca"
	    "n appear before, after,", (ftnlen)256, (ftnlen)73);
    s_copy(text + 10496, "   or intermixed with file names. The case of opti"
	    "on keys is significant:", (ftnlen)256, (ftnlen)73);
    s_copy(text + 10752, "   they must be lowercase as shown above. While an"
	    "y option can be provided", (ftnlen)256, (ftnlen)74);
    s_copy(text + 11008, "   together with any other option or a combination"
	    " of options, some options", (ftnlen)256, (ftnlen)75);
    s_copy(text + 11264, "   will override others.", (ftnlen)256, (ftnlen)24);
...
/*     If command line is blank display brief usage. */
	...
	for (i__ = 1; i__ <= 20; ++i__) {
	    tostdo_(utext + (((i__1 = i__ - 1) < 20 && 0 <= i__1 ? i__1 : 
		    s_rnge("utext", i__1, "ckbrief_", (ftnlen)592)) << 8), (
		    ftnlen)256);
	}
	tostdo_(" ", (ftnlen)1);
	s_stop("", (ftnlen)0);
...
/*     file containing these names. */
    ...
    if (help) {
	tostdo_(" ", (ftnlen)1);
	for (i__ = 1; i__ <= 46; ++i__) {
	    tostdo_(text + (((i__1 = i__ - 1) < 46 && 0 <= i__1 ? i__1 : 
		    s_rnge("text", i__1, "ckbrief_", (ftnlen)795)) << 8), (
		    ftnlen)256);
	}
	tostdo_(" ", (ftnlen)1);
	s_stop("", (ftnlen)0);
...
/*                 further in the program. */
			...
			ida[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
				s_rnge("ida", i__1, "ckbrief_", (ftnlen)1090)]
				 = ic[0];
			...
			avfa[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
				s_rnge("avfa", i__1, "ckbrief_", (ftnlen)1093)
				] = ic[3];
...
/*              flag further in the program. */
		...
		if (nobj <= 99999) {
		    fndsum = TRUE_;
		    ida[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("ida", i__1, "ckbrief_", (ftnlen)1121)] = 
			    ic[0];
		    framea[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("framea", i__1, "ckbrief_", (ftnlen)1122)] 
			    = ic[1];
		    typea[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("typea", i__1, "ckbrief_", (ftnlen)1123)] =
			     ic[2];
		    avfa[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("avfa", i__1, "ckbrief_", (ftnlen)1124)] = 
			    ic[3];
		    baddra[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("baddra", i__1, "ckbrief_", (ftnlen)1125)] 
			    = ic[4];
		    eaddra[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("eaddra", i__1, "ckbrief_", (ftnlen)1126)] 
			    = ic[5];
		    tstrta[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("tstrta", i__1, "ckbrief_", (ftnlen)1127)] 
			    = dc[0];
		    tenda[(i__1 = nobj - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("tenda", i__1, "ckbrief_", (ftnlen)1128)] =
			     dc[1];
		    ++nobj;
		} else {
		    fulbuf = TRUE_;
...
/*           signal an error. */
	    ...
	    if (fulbuf) {
		if (numobj > 0) {
		    setmsg_("The number of segments containing data for the "
			    "specified IDs in the CK file '#' was greater tha"
			    "n the program can buffer (#). CKBRIEF cannot sum"
			    "marize this file.", (ftnlen)160);
		    errch_("#", pass3 + (beg - 1), (ftnlen)1, end - (beg - 1))
			    ;
		    errint_("#", &c__99999, (ftnlen)1);
		    sigerr_("SPICE(BUFFEROVERRUN1)", (ftnlen)21);
		} else {
		    setmsg_("The number of segments in the CK file '#' was g"
			    "reater than the program can buffer (#). CKBRIEF "
			    "cannot summarize this file.", (ftnlen)122);
		    errch_("#", pass3 + (beg - 1), (ftnlen)1, end - (beg - 1))
			    ;
		    errint_("#", &c__99999, (ftnlen)1);
...
/* Writing concatenation */
		...
		i__2[1] = end - (beg - 1), a__1[1] = pass3 + (beg - 1);
		s_cat(ch__2, a__1, i__2, &c__2, (ftnlen)25033);
		tostdo_(ch__2, end - (beg - 1) + 33);
	    } else {
/* Writing concatenation */
		i__2[0] = 20, a__1[0] = "No data segments in ";
		i__2[1] = end - (beg - 1), a__1[1] = pass3 + (beg - 1);
		s_cat(ch__3, a__1, i__2, &c__2, (ftnlen)25020);
...
/*              type make sense? */
		...
		if (typea[(i__3 = i__ - 1) < 100000 && 0 <= i__3 ? i__3 : 
			s_rnge("typea", i__3, "ckbrief_", (ftnlen)1245)] == 2 
			|| typea[(i__4 = i__ - 1) < 100000 && 0 <= i__4 ? 
			i__4 : s_rnge("typea", i__4, "ckbrief_", (ftnlen)1245)
			] == 3 || typea[(i__5 = i__ - 1) < 100000 && 0 <= 
			i__5 ? i__5 : s_rnge("typea", i__5, "ckbrief_", (
			ftnlen)1245)] == 4 || typea[(i__6 = i__ - 1) < 100000 
...
/*                 ZZCKCRVx depending on what type the segment is. */
			...
			zzckcvr3_(&handle, &baddra[(i__3 = i__ - 1) < 100000 
				&& 0 <= i__3 ? i__3 : s_rnge("baddra", i__3, 
				"ckbrief_", (ftnlen)1262)], &eaddra[(i__4 = 
				i__ - 1) < 100000 && 0 <= i__4 ? i__4 : 
				s_rnge("eaddra", i__4, "ckbrief_", (ftnlen)
				1262)], wind);
		    } else if (typea[(i__3 = i__ - 1) < 100000 && 0 <= i__3 ? 
			...
			zzckcvr4_(&handle, &baddra[(i__3 = i__ - 1) < 100000 
				&& 0 <= i__3 ? i__3 : s_rnge("baddra", i__3, 
				"ckbrief_", (ftnlen)1266)], &eaddra[(i__4 = 
				i__ - 1) < 100000 && 0 <= i__4 ? i__4 : 
				s_rnge("eaddra", i__4, "ckbrief_", (ftnlen)
				1266)], wind);
		    } else if (typea[(i__3 = i__ - 1) < 100000 && 0 <= i__3 ? 
			...
			zzckcvr5_(&handle, &baddra[(i__3 = i__ - 1) < 100000 
				&& 0 <= i__3 ? i__3 : s_rnge("baddra", i__3, 
				"ckbrief_", (ftnlen)1270)], &eaddra[(i__4 = 
				i__ - 1) < 100000 && 0 <= i__4 ? i__4 : 
				s_rnge("eaddra", i__4, "ckbrief_", (ftnlen)
				1270)], wind);
		    }
...
/*                 intervals. Tell user about it. */
		    ...
		    repmi_(hword, "#", &typea[(i__3 = i__ - 1) < 100000 && 0 
			    <= i__3 ? i__3 : s_rnge("typea", i__3, "ckbrief_",
			     (ftnlen)1303)], hword, (ftnlen)256, (ftnlen)1, (
			    ftnlen)256);
		    tostdo_("  ", (ftnlen)2);
		    tostdo_(hword, (ftnlen)256);
		}
...
/*              already taken into account. */
		...
		while(ida[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ? i__1 : 
			s_rnge("ida", i__1, "ckbrief_", (ftnlen)1355)] == 0 &&
			 i__ <= nobj) {
		    ++i__;
		}
		if (i__ <= nobj) {
...
/*                 by setting its IDA to zero. */
		    ...
		    ida[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("ida", i__1, "ckbrief_", (ftnlen)1381)] = 
			    0;
...
/*                 buffer. */
		    ...
		    loc = isrchi_(&ido[(i__1 = nobgo - 2) < 100000 && 0 <= 
			    ...
			    ftnlen)1387)], &i__4, &ida[(i__3 = i__) < 100000 
...
/*                    remove it from IDO buffer. */
			...
			ids[(i__1 = nobgs - 1) < 100000 && 0 <= i__1 ? i__1 : 
				s_rnge("ids", i__1, "ckbrief_", (ftnlen)1423)]
...
/*                 last of them */
		    ...
		    while(ido[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ? i__1 : 
			    s_rnge("ido", i__1, "ckbrief_", (ftnlen)1458)] == 
			    ido[(i__3 = k - 1) < 100000 && 0 <= i__3 ? i__3 : 
			    s_rnge("ido", i__3, "ckbrief_", (ftnlen)1458)] && 
			    k <= nobgo) {
			++k;
		    }
...
/*                 a WINDOW array. */
			...
			wind[(i__3 = (l << 1) + 6) < 200006 && 0 <= i__3 ? 
				...
				ftnlen)1470)] = tstrto[(i__4 = l + i__ - 1) < 
				100000 && 0 <= i__4 ? i__4 : s_rnge("tstrto", 
				i__4, "ckbrief_", (ftnlen)1470)];
			wind[(i__3 = (l << 1) + 7) < 200006 && 0 <= i__3 ? 
				i__3 : s_rnge("wind", i__3, "ckbrief_", (
				ftnlen)1471)] = tendo[(i__4 = l + i__ - 1) < 
				100000 && 0 <= i__4 ? i__4 : s_rnge("tendo", 
				i__4, "ckbrief_", (ftnlen)1471)];
		    }
...
/*                    Now we can copy sorted data back to xxxS buffer. */
			...
			movei_(&ido[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ? 
				...
				ftnlen)1504)], &i__4, &ids[(i__3 = nobgs - 1) 
				< 100000 && 0 <= i__3 ? i__3 : s_rnge("ids", 
				i__3, "ckbrief_", (ftnlen)1504)]);
			i__4 = k - i__;
			moved_(&tstrto[(i__1 = i__ - 1) < 100000 && 0 <= i__1 
				? i__1 : s_rnge("tstrto", i__1, "ckbrief_", (
				ftnlen)1505)], &i__4, &tstrts[(i__3 = nobgs - 
				1) < 100000 && 0 <= i__3 ? i__3 : s_rnge(
				"tstrts", i__3, "ckbrief_", (ftnlen)1505)]);
			i__4 = k - i__;
			moved_(&tendo[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ?
				 i__1 : s_rnge("tendo", i__1, "ckbrief_", (
				ftnlen)1506)], &i__4, &tends[(i__3 = nobgs - 
				1) < 100000 && 0 <= i__3 ? i__3 : s_rnge(
				"tends", i__3, "ckbrief_", (ftnlen)1506)]);
			i__4 = k - i__;
			movei_(&avfo[(i__1 = i__ - 1) < 100000 && 0 <= i__1 ? 
				i__1 : s_rnge("avfo", i__1, "ckbrief_", (
				ftnlen)1507)], &i__4, &avfs[(i__3 = nobgs - 1)
				 < 100000 && 0 <= i__3 ? i__3 : s_rnge("avfs",
				 i__3, "ckbrief_", (ftnlen)1507)]);
			i__4 = k - i__;
			movei_(&frameo[(i__1 = i__ - 1) < 100000 && 0 <= i__1 
				? i__1 : s_rnge("frameo", i__1, "ckbrief_", (
				ftnlen)1508)], &i__4, &frames[(i__3 = nobgs - 
				1) < 100000 && 0 <= i__3 ? i__3 : s_rnge(
				"frames", i__3, "ckbrief_", (ftnlen)1508)]);
			nobgs = nobgs + k - i__;
		    } else {
...
/*                    set AVS to 2 and FRAMES to 0. */
			...
			while(l < k - 1) {
			    if (avfo[(i__1 = l - 1) < 100000 && 0 <= i__1 ? 
				    i__1 : s_rnge("avfo", i__1, "ckbrief_", (
				    ftnlen)1529)] != avfo[(i__3 = l) < 100000 
				    && 0 <= i__3 ? i__3 : s_rnge("avfo", i__3,
				     "ckbrief_", (ftnlen)1529)]) {
				mixdav = TRUE_;
			    }
			    if (frameo[(i__1 = l - 1) < 100000 && 0 <= i__1 ? 
				    i__1 : s_rnge("frameo", i__1, "ckbrief_", 
				    (ftnlen)1533)] != frameo[(i__3 = l) < 
				    100000 && 0 <= i__3 ? i__3 : s_rnge("fra"
				    "meo", i__3, "ckbrief_", (ftnlen)1533)]) {
				mixdfr = TRUE_;
			    }
			    ++l;
			}
...
/*                       Copy summaries to IDS, etc. arrays. */
			    ...
			    ids[(i__1 = nobgs - 1) < 100000 && 0 <= i__1 ? 
				    ...
				    ftnlen)1571)] = ido[(i__3 = i__ - 1) < 
				    100000 && 0 <= i__3 ? i__3 : s_rnge("ido",
				     i__3, "ckbrief_", (ftnlen)1571)];
			    avfs[(i__1 = nobgs - 1) < 100000 && 0 <= i__1 ? 
				    i__1 : s_rnge("avfs", i__1, "ckbrief_", (
				    ftnlen)1572)] = avfo[(i__3 = i__ - 1) < 
				    100000 && 0 <= i__3 ? i__3 : s_rnge("avfo"
				    , i__3, "ckbrief_", (ftnlen)1572)];
			    frames[(i__1 = nobgs - 1) < 100000 && 0 <= i__1 ? 
				    i__1 : s_rnge("frames", i__1, "ckbrief_", 
				    (ftnlen)1573)] = frameo[(i__3 = i__ - 1) <
				     100000 && 0 <= i__3 ? i__3 : s_rnge(
				    "frameo", i__3, "ckbrief_", (ftnlen)1573)]
				    ;
			    tstrts[(i__1 = nobgs - 1) < 100000 && 0 <= i__1 ? 
				    i__1 : s_rnge("tstrts", i__1, "ckbrief_", 
				    (ftnlen)1574)] = wind[6];
