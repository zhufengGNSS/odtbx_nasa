...
static doublereal c_b794 = 0.;
static doublereal c_b967 = 1e-8;
...
/* Subroutine */ int chwcml_(char *line, char *kernam, char *ffrnam, integer *
	...
	aunits, ftnlen line_len, ftnlen kernam_len, ftnlen ffrnam_len, ftnlen 
	tfrnam_len, ftnlen diftyp_len, ftnlen timfmt_len, ftnlen kernls_len, 
	ftnlen aunits_len)
{
    /* Initialized data */

    static char clkeys[32*24] = "-k                              " "-t1     "
	    "                        " "-f1                             " 
	    "-c1                             " "-k1                         "
	    "    " "-t2                             " "-f2                   "
	    "          " "-c2                             " "-k2             "
    ...
    static integer i__;
    extern /* Subroutine */ int dafgs_(doublereal *), ckobj_(char *, integer *
	    , ftnlen);
    ...
    static char cfrnam[32*2];
    extern integer isrchc_(char *, integer *, char *, ftnlen, ftnlen), 
	    wncard_(doublereal *);
    static char clvals[1024*24];
    extern logical exists_(char *, ftnlen);
    static char arctyp[7*2], hartyp[7], hlpmsg[80*28], usgmsg[80*32], vermsg[
	    80*3], hlline[5120], hkrnam[1024], clkeyu[32*24], covdsc[1024*2], 
	    timdsc[1024];
    ...
    extern /* Subroutine */ int tkvrsn_(char *, char *, ftnlen, ftnlen), 
	    ...
	    ftnlen, ftnlen, ftnlen), tostdo_(char *, ftnlen), getfat_(char *, 
	    char *, char *, ftnlen, ftnlen, ftnlen), setmsg_(char *, ftnlen), 
	    sigerr_(char *, ftnlen), ssizei_(integer *, integer *), pckfrm_(
	    char *, integer *, ftnlen), nextwd_(char *, char *, char *, 
	    ftnlen, ftnlen, ftnlen), ldklst_(char *, ftnlen), nparsi_(char *, 
	    integer *, char *, integer *, ftnlen, ftnlen), namfrm_(char *, 
	    integer *, ftnlen), frmnam_(integer *, char *, ftnlen), frinfo_(
	    integer *, integer *, integer *, integer *, logical *), errint_(
	    char *, integer *, ftnlen), dafopr_(char *, integer *, ftnlen), 
	    ssized_(integer *, doublereal *), ckcovr_(char *, integer *, 
	    logical *, char *, doublereal *, doublereal *, ftnlen, ftnlen), 
	    pckcov_(char *, integer *, doublereal *, ftnlen), wninsd_(
	    doublereal *, doublereal *, doublereal *), wnintd_(doublereal *, 
	    doublereal *, doublereal *), nparsd_(char *, doublereal *, char *,
	     integer *, ftnlen, ftnlen), wnfetd_(doublereal *, integer *, 
	    doublereal *, doublereal *), ckmeta_(integer *, char *, integer *,
...
/*     Generate uppercase version of command lines keys. */
	...
	ucase_(clkeys + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clkeys", i__1, "chwcml_", (ftnlen)318)) << 5), clkeyu + (((
		i__2 = i__ - 1) < 24 && 0 <= i__2 ? i__2 : s_rnge("clkeyu", 
		i__2, "chwcml_", (ftnlen)318)) << 5), (ftnlen)32, (ftnlen)32);
    }
...
/* Writing concatenation */
    i__3[0] = 63, a__1[0] = "frmdiff -- Version 1.0.0, February 10, 2009 -- "
	    "Toolkit Version ";
...
/*     Initialize usage display. */
    ...
    s_copy(usgmsg + 1680, "      #  <compare angular velocities: #|#>", (
	    ftnlen)80, (ftnlen)42);
    s_copy(usgmsg + 1760, "      #  <frame for angular velocities: #|#>", (
	    ftnlen)80, (ftnlen)44);
    ...
    s_copy(usgmsg + 2480, " ", (ftnlen)80, (ftnlen)1);
    ...
    repmi_(usgmsg + 2000, "#", &c__1, usgmsg + 2000, (ftnlen)80, (ftnlen)1, (
	    ftnlen)80);
    repmi_(usgmsg + 2000, "#", &c_b113, usgmsg + 2000, (ftnlen)80, (ftnlen)1, 
	    (ftnlen)80);
...
/*     variations was present. */
    ...
    parcml_(hline, &c__24, clkeyu, clflag, clvals, &found, (ftnlen)1024, (
...
/*     keys present? Display usage, help, or version and stop. */
    ...
    if (nargs == 0 || clflag[(i__1 = isrchc_("-v", &c__24, clkeys, (ftnlen)2, 
	    (ftnlen)32) - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", i__1,
	     "chwcml_", (ftnlen)514)] || clflag[(i__2 = isrchc_("-help", &
	    c__24, clkeys, (ftnlen)5, (ftnlen)32) - 1) < 24 && 0 <= i__2 ? 
	    i__2 : s_rnge("clflag", i__2, "chwcml_", (ftnlen)514)] || clflag[(
	    i__4 = isrchc_("-h", &c__24, clkeys, (ftnlen)2, (ftnlen)32) - 1) <
	     24 && 0 <= i__4 ? i__4 : s_rnge("clflag", i__4, "chwcml_", (
	    ftnlen)514)] || clflag[(i__5 = isrchc_("-usage", &c__24, clkeys, (
	    ftnlen)6, (ftnlen)32) - 1) < 24 && 0 <= i__5 ? i__5 : s_rnge(
	    "clflag", i__5, "chwcml_", (ftnlen)514)] || clflag[(i__6 = 
	    isrchc_("-u", &c__24, clkeys, (ftnlen)2, (ftnlen)32) - 1) < 24 && 
	    0 <= i__6 ? i__6 : s_rnge("clflag", i__6, "chwcml_", (ftnlen)514)]
	    ) {
...
/*        Display version in all cases. */
	...
	for (i__ = 1; i__ <= 3; ++i__) {
	    tostdo_(vermsg + ((i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : 
		    s_rnge("vermsg", i__1, "chwcml_", (ftnlen)525)) * 80, (
		    ftnlen)80);
	}
...
/*        usage, help, or nothing and stop. */
	...
	if (nargs == 0 || clflag[(i__1 = isrchc_("-usage", &c__24, clkeys, (
		ftnlen)6, (ftnlen)32) - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clflag", i__1, "chwcml_", (ftnlen)532)] || clflag[(i__2 = 
		isrchc_("-u", &c__24, clkeys, (ftnlen)2, (ftnlen)32) - 1) < 
		24 && 0 <= i__2 ? i__2 : s_rnge("clflag", i__2, "chwcml_", (
		ftnlen)532)]) {
	    for (i__ = 1; i__ <= 32; ++i__) {
		tostdo_(usgmsg + ((i__1 = i__ - 1) < 32 && 0 <= i__1 ? i__1 : 
			s_rnge("usgmsg", i__1, "chwcml_", (ftnlen)537)) * 80, 
			(ftnlen)80);
	    }
	} else if (clflag[(i__1 = isrchc_("-help", &c__24, clkeys, (ftnlen)5, 
		(ftnlen)32) - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
		i__1, "chwcml_", (ftnlen)540)] || clflag[(i__2 = isrchc_(
		"-h", &c__24, clkeys, (ftnlen)2, (ftnlen)32) - 1) < 24 && 0 <=
		 i__2 ? i__2 : s_rnge("clflag", i__2, "chwcml_", (ftnlen)540)]
		) {
	    for (i__ = 1; i__ <= 28; ++i__) {
		tostdo_(hlpmsg + ((i__1 = i__ - 1) < 28 && 0 <= i__1 ? i__1 : 
			s_rnge("hlpmsg", i__1, "chwcml_", (ftnlen)545)) * 80, 
			(ftnlen)80);
	    }
	}
	s_stop("", (ftnlen)0);
...
/*     with looking for kernels applicable to the first attitude set. */
    ...
    i__ = isrchc_("-k1", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)697)]) {
	if (s_cmp(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)699)) << 10), " ", (
		ftnlen)1024, (ftnlen)1) != 0) {
	    s_copy(kernls, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		    i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)701)) << 
...
/*     Second, look for kernels applicable to the second attitude set. */
    ...
    i__ = isrchc_("-k2", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)738)]) {
	if (s_cmp(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)740)) << 10), " ", (
		ftnlen)1024, (ftnlen)1) != 0) {
	    s_copy(kernls + kernls_len, clvals + (((i__1 = i__ - 1) < 24 && 0 
		    <= i__1 ? i__1 : s_rnge("clvals", i__1, "chwcml_", (
		    ftnlen)742)) << 10), kernls_len, (ftnlen)1024);
...
/*     Last, look for kernels applicable to both attitude sets. */
    ...
    i__ = isrchc_("-k", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)779)]) {
	if (s_cmp(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)781)) << 10), " ", (
		ftnlen)1024, (ftnlen)1) != 0) {
	    s_copy(kernls + (kernls_len << 1), clvals + (((i__1 = i__ - 1) < 
		    24 && 0 <= i__1 ? i__1 : s_rnge("clvals", i__1, "chwcml_",
		     (ftnlen)783)) << 10), kernls_len, (ftnlen)1024);
...
/*     Start with getting the first ``from'' frame. */
    ...
    ffrid[0] = 0;
    i__ = isrchc_("-f1", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)866)]) {

/*        The first ``from'' frame was provided on the command line. Was */
/*        it given as a name or as an ID? Try to convert it to integer */
/*        as see if it worked. */

	s_copy(ffrnam, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)873)) << 10), 
		ffrnam_len, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)874)) << 10), ffrid, error,
...
/*           try to convert it to ID. If we can't, report an error. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)882)) << 10), 
		    ffrid, (ftnlen)1024);
	    if (ffrid[0] == 0) {
		...
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)890))
...
/*           convert it to name. If we can't, report an error. */
		...
		setmsg_("'#' specified after '#' key is neither an integer n"
			...
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)909))
			 << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-f1", (ftnlen)1, (ftnlen)3);
...
/*     Next, get the first ``to'' frame. */
    ...
    tfrcid[0] = 0;
    tfrcls[0] = 0;
    i__ = isrchc_("-t1", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)928)]) {

/*        The first ``to'' frame was provided on the command line. Was */
/*        it given as a name or as an ID? Try to convert it to integer */
/*        and see if it worked. */

	s_copy(tfrnam, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)935)) << 10), 
		tfrnam_len, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)936)) << 10), tfrid, error,
		 &ptr, (ftnlen)1024, (ftnlen)1024);
	if (ptr != 0) {
...
/*           try to convert it to ID. If we can't, report an error. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)944)) << 10), 
		    tfrid, (ftnlen)1024);
	    if (tfrid[0] == 0) {
		setmsg_("'#' specified after '#' key is neither an integer n"
			"umber representing a legitimate frame ID nor a frame"
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)952))
			 << 10), (ftnlen)1, (ftnlen)1024);
...
/*           it can't be mapped, report an error. */
		...
		if (s_cmp(tfrnam, " ", tfrnam_len, (ftnlen)1) == 0) {
		    ...
		    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 
			    ...
			    ftnlen)1014)) << 10), (ftnlen)1, (ftnlen)1024);
		    errch_("#", "-t1", (ftnlen)1, (ftnlen)3);
...
/*     Next, get the first ``coverage'' frame name or class ID. */
    ...
    cfrcls[0] = 0;
    cfrfnd[0] = FALSE_;
    i__ = isrchc_("-c1", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1042)]) {
...
/*        this file. */
	...
	s_copy(cfrnam, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)1090)) << 10), (
		ftnlen)32, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1091)) << 10), cfrcid, 
...
/*           try to get its ID. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)1099)) << 10), 
		    cfrcid, (ftnlen)1024);
	    if (cfrcid[0] == 0) {
		setmsg_("'#' specified after '#' key is neither an integer n"
			"umber representing a legitimate frame ID nor a frame"
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1107)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c1", (ftnlen)1, (ftnlen)3);
...
/*           how many files were provided. */
		...
		if (found) {
		    ...
		    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 
			    ? i__1 : s_rnge("clvals", i__1, "chwcml_", (
			    ftnlen)1146)) << 10), (ftnlen)1, (ftnlen)1024);
		...
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1162)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c1", (ftnlen)1, (ftnlen)3);
		errch_("#", hkrnam, (ftnlen)1, (ftnlen)1024);
...
/*           error. */
		...
		errch_("#", hkrnam, (ftnlen)1, (ftnlen)1024);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1193)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c1", (ftnlen)1, (ftnlen)3);
...
/*     Start with getting the second ``from'' frame. */
    ...
    ffrid[1] = 0;
    i__ = isrchc_("-f2", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1241)]) {
...
/*        integer and see if it worked. */
	...
	s_copy(ffrnam + ffrnam_len, clvals + (((i__1 = i__ - 1) < 24 && 0 <= 
		i__1 ? i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1248))
		 << 10), ffrnam_len, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1249)) << 10), &ffrid[1], 
		error, &ptr, (ftnlen)1024, (ftnlen)1024);
	if (ptr != 0) {
...
/*           try to convert it to ID. If we can't, report an error. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)1257)) << 10), &
		    ffrid[1], (ftnlen)1024);
	    if (ffrid[1] == 0) {
		setmsg_("'#' specified after '#' key is neither an integer n"
			"umber representing a legitimate frame ID nor a frame"
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1265)
			) << 10), (ftnlen)1, (ftnlen)1024);
...
/*           convert it to name. If we can't, report an error. */
		...
		setmsg_("'#' specified after '#' key is neither an integer n"
			...
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1284)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-f2", (ftnlen)1, (ftnlen)3);
...
/*     Next, get the second ``to'' frame. */
    ...
    tfrcid[1] = 0;
    tfrcls[1] = 0;
    i__ = isrchc_("-t2", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1303)]) {

/*        The second ``to'' frame was provided on the command line. Was */
/*        it given as a name or as an ID? Try to convert it to integer */
/*        and see if it worked. */

	s_copy(tfrnam + tfrnam_len, clvals + (((i__1 = i__ - 1) < 24 && 0 <= 
		i__1 ? i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1310))
		 << 10), tfrnam_len, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1311)) << 10), &tfrid[1], 
		error, &ptr, (ftnlen)1024, (ftnlen)1024);
	if (ptr != 0) {
...
/*           try to convert it to ID. If we can't, report an error. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)1319)) << 10), &
		    tfrid[1], (ftnlen)1024);
	    if (tfrid[1] == 0) {
		setmsg_("'#' specified after '#' key is neither an integer n"
			"umber representing a legitimate frame ID nor a frame"
...
/*           it can't be mapped, report an error. */
		...
		if (s_cmp(tfrnam + tfrnam_len, " ", tfrnam_len, (ftnlen)1) == 
		    ...
		    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 
			    ? i__1 : s_rnge("clvals", i__1, "chwcml_", (
			    ftnlen)1386)) << 10), (ftnlen)1, (ftnlen)1024);
		    errch_("#", "-t2", (ftnlen)1, (ftnlen)3);
...
/*     Next, get the second ``coverage'' frame name or class ID. */
    ...
    cfrcls[1] = 0;
    cfrfnd[1] = FALSE_;
    i__ = isrchc_("-c2", &c__24, clkeys, (ftnlen)3, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1414)]) {
...
/*        this file. */
	...
	s_copy(cfrnam + 32, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1456)) << 10)
		, (ftnlen)32, (ftnlen)1024);
	nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1457)) << 10), &cfrcid[1], 
		error, &ptr, (ftnlen)1024, (ftnlen)1024);
	if (ptr != 0) {
...
/*           try to get its ID. */
	    ...
	    namfrm_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)1465)) << 10), &
		...
		setmsg_("'#' specified after '#' key is neither an integer n"
			...
			" name recognized in SPICE.", (ftnlen)129);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1473)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c2", (ftnlen)1, (ftnlen)3);
...
/*           IDs present in the file. */
		...
		if (found) {
		    ...
		    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 
			    ? i__1 : s_rnge("clvals", i__1, "chwcml_", (
			    ftnlen)1504)) << 10), (ftnlen)1, (ftnlen)1024);
		    errint_("#", &clssid, (ftnlen)1);
		    errch_("#", "-c2", (ftnlen)1, (ftnlen)3);
		...
		setmsg_("The class of the frame '#' provided after '#' key d"
			...
			" architecture/type were '#'.", (ftnlen)183);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1520)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c2", (ftnlen)1, (ftnlen)3);
		errch_("#", hkrnam, (ftnlen)1, (ftnlen)1024);
...
/*           error. */
		...
		errch_("#", hkrnam, (ftnlen)1, (ftnlen)1024);
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1545)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-c2", (ftnlen)1, (ftnlen)3);
...
/*     the output angular velocity flag (AVFLG) based on its value. */
    ...
    i__ = isrchc_("-a", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    *avflg = FALSE_;
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1574)]) {
	if (eqstr_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)1576)) << 10), 
		"yes", (ftnlen)1024, (ftnlen)3)) {
	    *avflg = TRUE_;
	} else if (eqstr_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1580)) << 10)
	    ...
	    *avflg = FALSE_;
	    ...
	    setmsg_("Angular velocity comparison flag '#' specified after '#"
		    ...
		    "#'.", (ftnlen)114);
	    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 :
		     s_rnge("clvals", i__1, "chwcml_", (ftnlen)1590)) << 10), 
...
/*     output angular velocity frame flag (AVFFLG) based on its value. */
    ...
    i__ = isrchc_("-m", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1606)]) {
	if (eqstr_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)1608)) << 10), 
		"from", (ftnlen)1024, (ftnlen)4)) {
	    *avfflg = FALSE_;
	} else if (eqstr_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1612)) << 10)
	    ...
	    *avfflg = TRUE_;
	    ...
	    setmsg_("Angular velocity frame flag '#' specified after '#' key"
		    ...
		    ftnlen)109);
	    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 :
		     s_rnge("clvals", i__1, "chwcml_", (ftnlen)1622)) << 10), 
		    (ftnlen)1, (ftnlen)1024);
...
/* Writing concatenation */
    ...
    et[0] = dpmin_();
    i__ = isrchc_("-b", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1654)]) {
	s_copy(time, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)1655)) << 10), (
		ftnlen)1024, (ftnlen)1024);
	str2et_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1656)) << 10), et, (ftnlen)
		1024);
    }
    s_copy(time + 1024, " ", (ftnlen)1024, (ftnlen)1);
    et[1] = dpmax_();
    i__ = isrchc_("-e", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)1664)]) {
	s_copy(time + 1024, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)1665)) << 10)
		, (ftnlen)1024, (ftnlen)1024);
	str2et_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)1666)) << 10), &et[1], (
		ftnlen)1024);
    }
...
/*     If our files are CKs or PCKs and ``cov'' frame attributes are */
/*     missing, set them as well. */

    if (s_cmp(cfrnam, " ", (ftnlen)32, (ftnlen)1) == 0) {
	if (s_cmp(arctyp, "DAF/CK", (ftnlen)7, (ftnlen)6) == 0 || s_cmp(
		arctyp, "DAF/PCK", (ftnlen)7, (ftnlen)7) == 0) {
	    s_copy(cfrnam, tfrnam, (ftnlen)32, tfrnam_len);
	    cfrcid[0] = tfrcid[0];
	    cfrcls[0] = tfrcls[0];
	    cfrfnd[0] = elemi_(cfrcid, flids1);
	}
	if (s_cmp(kernam, " ", kernam_len, (ftnlen)1) == 0 && (s_cmp(arctyp + 
		7, "DAF/CK", (ftnlen)7, (ftnlen)6) == 0 || s_cmp(arctyp + 7, 
		"DAF/PCK", (ftnlen)7, (ftnlen)7) == 0)) {
	    s_copy(cfrnam, tfrnam, (ftnlen)32, tfrnam_len);
	    cfrcid[0] = tfrcid[0];
	    cfrcls[0] = tfrcls[0];
	    cfrfnd[0] = elemi_(cfrcid, flids2);
	...
	if (s_cmp(arctyp + 7, "DAF/CK", (ftnlen)7, (ftnlen)6) == 0 || s_cmp(
		arctyp + 7, "DAF/PCK", (ftnlen)7, (ftnlen)7) == 0) {
...
/*     If we got no file(s) on the command line or if this(ese) file(s) */
/*     is/are not CK or binary PCK, the user must have provided start */
/*     and stop times on the command line. If not, we stop. */

/*     If one of the two files or the only file is CK or binary PCK, we */
/*     will try to get coverage window from it and further restrict this */
/*     window using start and stop times if they were provided. */

/*     If both files are CKs and/or binary PCKs, we will try to get */
/*     coverage window from each of them, intersect these windows and */
/*     them and further restrict the resulting window using start and */
/*     stop times if they were provided. */
...
/*     missing start or stop. */
    ...
    if (s_cmp(kernam, " ", kernam_len, (ftnlen)1) == 0 && s_cmp(kernam + 
	    kernam_len, " ", kernam_len, (ftnlen)1) == 0 && (s_cmp(time, 
	    " ", (ftnlen)1024, (ftnlen)1) == 0 || s_cmp(time + 1024, " ", (
	    ftnlen)1024, (ftnlen)1) == 0)) {
	setmsg_("Cannot determine time range for comparison. Both start time"
		" and stop time must be provided using '#' and '#' keys when "
		"no files are given on the command line.", (ftnlen)158);
	errch_("#", "-b", (ftnlen)1, (ftnlen)2);
	errch_("#", "-e", (ftnlen)1, (ftnlen)2);
	sigerr_("SPICE(NOTIMEBOUNDS1)", (ftnlen)20);
    }

/*     Next check is for one file not CK or binary PCK and missing start */
/*     or stop. */

    if (s_cmp(kernam, " ", kernam_len, (ftnlen)1) == 0 && (s_cmp(arctyp + 7, 
	    "DAF/CK", (ftnlen)7, (ftnlen)6) != 0 && s_cmp(arctyp + 7, "DAF/P"
	    "CK", (ftnlen)7, (ftnlen)7) != 0) && (s_cmp(time, " ", (ftnlen)
	    1024, (ftnlen)1) == 0 || s_cmp(time + 1024, " ", (ftnlen)1024, (
	    ftnlen)1) == 0)) {
	setmsg_("Cannot determine time range for comparison. Both start time"
		" and stop time must be provided using '#' and '#' keys when "
		"the only file given on the command line -- '#' -- is not a C"
		"K or binary PCK.", (ftnlen)195);
	errch_("#", "-b", (ftnlen)1, (ftnlen)2);
	errch_("#", "-e", (ftnlen)1, (ftnlen)2);
	errch_("#", kernam + kernam_len, (ftnlen)1, kernam_len);
	sigerr_("SPICE(NOTIMEBOUNDS2)", (ftnlen)20);
    }

/*     Next check is for two files not CK or binary PCK and missing */
/*     start or stop. */

    if (s_cmp(arctyp, "DAF/CK", (ftnlen)7, (ftnlen)6) != 0 && s_cmp(arctyp, 
	    "DAF/PCK", (ftnlen)7, (ftnlen)7) != 0 && (s_cmp(arctyp + 7, "DAF"
	    "/CK", (ftnlen)7, (ftnlen)6) != 0 && s_cmp(arctyp + 7, "DAF/PCK", (
	    ftnlen)7, (ftnlen)7) != 0) && (s_cmp(time, " ", (ftnlen)1024, (
	    ftnlen)1) == 0 || s_cmp(time + 1024, " ", (ftnlen)1024, (ftnlen)1)
	     == 0)) {
	setmsg_("Cannot determine time range for comparison. Both start time"
		" and stop time must be provided using '#' and '#' keys when "
		"both files given on the command line -- '#' and '#' -- are n"
		"ot CKs or binary PCKs.", (ftnlen)201);
	errch_("#", "-b", (ftnlen)1, (ftnlen)2);
	errch_("#", "-e", (ftnlen)1, (ftnlen)2);
	errch_("#", kernam, (ftnlen)1, kernam_len);
	errch_("#", kernam + kernam_len, (ftnlen)1, kernam_len);
	sigerr_("SPICE(NOTIMEBOUNDS3)", (ftnlen)20);
    }
...
/*     them and do more checks after that. For the first coverage frame */
/*     we may get coverage either from the first or the only file. For */
/*     the second coverage frame we will try to get coverage from the */
/*     second or only file. But first, let's initialize our coverage */
/*     windows. */

    ssized_(&c_b113, cover1);
    scardd_(&c__0, cover1);
    ssized_(&c_b113, cover2);
    scardd_(&c__0, cover2);

/*     Try to get coverage for the first coverage frame if */
...
/*        level, with zero tolerance, and angular rate flag set earlier. */
	...
	ckcovr_(hkrnam, cfrcid, avflg, "INTERVAL", &c_b794, cover1, (ftnlen)
		1024, (ftnlen)8);
...
/*           string. Otherwise, use only frame class ID. */
	    ...
	    if (ptr != 0) {
		s_copy(covdsc, "Coverage for the CK frame '#' (class ID '#')"
			" was determined from CK file '#'.", (ftnlen)1024, (
			ftnlen)77);
		...
		s_copy(covdsc, "Coverage for the CK frame with class ID '#' "
			"was determined from CK file '#'.", (ftnlen)1024, (
			ftnlen)76);
		repmi_(covdsc, "#", cfrcid, covdsc, (ftnlen)1024, (ftnlen)1, (
			ftnlen)1024);
...
/*     No need to reload any kernels for PCK coverage look up. */
    ...
    if (s_cmp(kernam, " ", kernam_len, (ftnlen)1) != 0 && s_cmp(arctyp, "DAF"
	    "/PCK", (ftnlen)7, (ftnlen)7) == 0 && cfrcls[0] == 2 && cfrfnd[0] 
	    || s_cmp(kernam, " ", kernam_len, (ftnlen)1) == 0 && s_cmp(arctyp 
	    + 7, "DAF/PCK", (ftnlen)7, (ftnlen)7) == 0 && cfrcls[0] == 2 && 
	    cfrfnd[0]) {
...
/*           string. Otherwise, use only frame class ID. */
	    ...
	    nparsi_(cfrnam, &hint, error, &ptr, (ftnlen)32, (ftnlen)1024);
	    if (ptr != 0) {
		s_copy(covdsc, "Coverage for the PCK frame '#' (class ID '#'"
			") was determined from PCK file '#'.", (ftnlen)1024, (
			ftnlen)79);
		repmc_(covdsc, "#", cfrnam, covdsc, (ftnlen)1024, (ftnlen)1, (
			ftnlen)32, (ftnlen)1024);
		repmi_(covdsc, "#", cfrcid, covdsc, (ftnlen)1024, (ftnlen)1, (
		...
		s_copy(covdsc, "Coverage for the PCK frame with class ID  '#"
			"' was determined from PCK file '#'.", (ftnlen)1024, (
			ftnlen)79);
		repmi_(covdsc, "#", cfrcid, covdsc, (ftnlen)1024, (ftnlen)1, (
			ftnlen)1024);
...
/*     Get coverage for the second coverage frame if */
...
/*     conversions, clear loaded kernels and reload the second file and */
/*     all kernels applicable to the second attitude set. */
...
/*        level, with zero tolerance, and angular rate flag set earlier. */
	...
	ckcovr_(kernam + kernam_len, &cfrcid[1], avflg, "INTERVAL", &c_b794, 
...
/*           string. Otherwise, use only frame class ID. */
	    ...
	    nparsi_(cfrnam + 32, &hint, error, &ptr, (ftnlen)32, (ftnlen)1024)
		    ;
	    if (ptr != 0) {
		s_copy(covdsc + 1024, "Coverage for the CK frame '#' (class "
			"ID '#') was determined from CK file '#'.", (ftnlen)
			1024, (ftnlen)77);
		...
		s_copy(covdsc + 1024, "Coverage for the CK frame with class "
			"ID '#' was determined from CK file '#'.", (ftnlen)
			1024, (ftnlen)76);
		repmi_(covdsc + 1024, "#", &cfrcid[1], covdsc + 1024, (ftnlen)
			1024, (ftnlen)1, (ftnlen)1024);
...
/*     Get coverage for the second coverage frame if the second file is */
/*     is a PCK, the frame is a PCK frame, and data for frame's class ID */
/*     is present in the file. No need to reload any kernels for PCK */
/*     coverage look up. */

    if (s_cmp(arctyp + 7, "DAF/PCK", (ftnlen)7, (ftnlen)7) == 0 && cfrcls[1] 
	    == 2 && cfrfnd[1]) {
...
/*           string. Otherwise, use only frame class ID. */
	    ...
	    nparsi_(cfrnam + 32, &hint, error, &ptr, (ftnlen)32, (ftnlen)1024)
		    ;
	    if (ptr != 0) {
		s_copy(covdsc + 1024, "Coverage for the PCK frame '#' (class"
			" ID '#') was determined from PCK file '#'.", (ftnlen)
			1024, (ftnlen)79);
		repmc_(covdsc + 1024, "#", cfrnam + 32, covdsc + 1024, (
			ftnlen)1024, (ftnlen)1, (ftnlen)32, (ftnlen)1024);
		repmi_(covdsc + 1024, "#", &cfrcid[1], covdsc + 1024, (ftnlen)
		...
		s_copy(covdsc + 1024, "Coverage for the PCK frame with class"
			" ID  '#' was determined from PCK file '#'.", (ftnlen)
			1024, (ftnlen)79);
		repmi_(covdsc + 1024, "#", &cfrcid[1], covdsc + 1024, (ftnlen)
			1024, (ftnlen)1, (ftnlen)1024);
...
/*     frames but with no data in the files.) */
	...
	setmsg_("Insufficient information was provided on the command line t"
		...
		" to perform comparison for CKs and/or binary PCKs, the '#' a"
		"nd/or '#' keys can be used to direct the program to determin"
		"e default coverage using data from the files. Otherwise, bot"
		"h of the '#' and '#' keys must be used to specify the start "
		"and stop times of the comparison window.", (ftnlen)399);
	errch_("#", "-c1", (ftnlen)1, (ftnlen)3);
	errch_("#", "-c2", (ftnlen)1, (ftnlen)3);
	errch_("#", "-b", (ftnlen)1, (ftnlen)2);
	errch_("#", "-e", (ftnlen)1, (ftnlen)2);
...
/*        an error if intersection is empty. */
	...
	if (wncard_(cmpwin) == 0) {
	    ...
	    if (s_cmp(kernam, " ", kernam_len, (ftnlen)1) != 0) {
		errch_("#", "kernels", (ftnlen)1, (ftnlen)7);
	    } else {
		errch_("#", "kernel", (ftnlen)1, (ftnlen)6);
	    }
...
/*        start/stop window. Report an error if intersection is empty. */
	...
	if (wncard_(cmpwin) == 0) {
	    setmsg_("Cannot determine time range for comparison because the "
		    "coverage window obtained by examining the kernel provide"
		    "d on the command line does not overlap the time range sp"
		    "ecified in the command line using '#' and/or '#' keys. #"
		    " #", (ftnlen)225);
	    errch_("#", "-b", (ftnlen)1, (ftnlen)2);
	    errch_("#", "-e", (ftnlen)1, (ftnlen)2);
	    errch_("#", covdsc, (ftnlen)1, (ftnlen)1024);
...
/*     Start with the type of output. Default type is basic. */
    ...
    i__ = isrchc_("-t", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)2576)]) {
	s_copy(diftyp, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		s_rnge("clvals", i__1, "chwcml_", (ftnlen)2578)) << 10), 
	...
	if (! (eqstr_(diftyp, "basic", diftyp_len, (ftnlen)5) || eqstr_(
	    ...
	    setmsg_("Output type '#' specified after '#' key is not recogniz"
		    ...
		    " '#', '#', '#', and '#'.", (ftnlen)135);
	    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 :
		     s_rnge("clvals", i__1, "chwcml_", (ftnlen)2595)) << 10), 
		    (ftnlen)1, (ftnlen)1024);
...
/*     in the include file. */
    ...
    *step = 0.;
    *nitr = 1000;
    i__ = isrchc_("-s", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
    if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag", 
	    i__1, "chwcml_", (ftnlen)2624)]) {

/*        Is the step a DP number? */

	nparsd_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge(
		"clvals", i__1, "chwcml_", (ftnlen)2629)) << 10), step, error,
		 &ptr, (ftnlen)1024, (ftnlen)1024);
	if (ptr == 0) {
...
/*           the smallest step we can allow. */
		...
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)2641)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-s", (ftnlen)1, (ftnlen)2);
		errdp_("#", &c_b967, (ftnlen)1);
...
/*                    string to indicate a bug. */
	    ...
	    setmsg_("Time step '#' specified after '#' key is not a DP numbe"
		    "r.", (ftnlen)57);
	    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 :
		     s_rnge("clvals", i__1, "chwcml_", (ftnlen)2768)) << 10), 
		    (ftnlen)1, (ftnlen)1024);
	    errch_("#", "-s", (ftnlen)1, (ftnlen)2);
...
/*        number of steps? */
	...
	i__ = isrchc_("-n", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
	if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag"
		, i__1, "chwcml_", (ftnlen)2781)]) {

/*           Is the number of step an integer number? */

	    nparsi_(clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : 
		    s_rnge("clvals", i__1, "chwcml_", (ftnlen)2786)) << 10), 
		...
		errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
			i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)2807)
			) << 10), (ftnlen)1, (ftnlen)1024);
		errch_("#", "-n", (ftnlen)1, (ftnlen)2);
...
/*     format is ET seconds. Default SCLK ID is zero (means "not set"). */
    ...
    if (eqstr_(diftyp, "dumpm", diftyp_len, (ftnlen)5) || eqstr_(diftyp, 
	    ...
	    "dumpg", diftyp_len, (ftnlen)5)) {
	i__ = isrchc_("-f", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
	if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag"
		, i__1, "chwcml_", (ftnlen)2835)]) {
	    s_copy(timfmt, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		    i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)2837)) <<
...
/* Writing concatenation */
		    ...
		    errch_("#", clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 
			    ? i__1 : s_rnge("clvals", i__1, "chwcml_", (
			    ftnlen)2913)) << 10), (ftnlen)1, (ftnlen)1024);
...
/*        Check if rotation order was provided. */
	...
	i__ = isrchc_("-o", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
	if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag"
		, i__1, "chwcml_", (ftnlen)3050)]) {
	    s_copy(hline, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		    i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)3052)) <<
...
/*                 recognize the token, report an error. */
			...
			axes[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : 
				s_rnge("axes", i__1, "chwcml_", (ftnlen)3070)]
				 = 1;
		    } else if (eqstr_(hword, "y", (ftnlen)32, (ftnlen)1)) {
			axes[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : 
				s_rnge("axes", i__1, "chwcml_", (ftnlen)3072)]
				 = 2;
		    } else if (eqstr_(hword, "z", (ftnlen)32, (ftnlen)1)) {
			axes[(i__1 = i__ - 1) < 3 && 0 <= i__1 ? i__1 : 
				s_rnge("axes", i__1, "chwcml_", (ftnlen)3074)]
				 = 3;
		    } else {
...
/*        Check if angle units were provided. */
	...
	i__ = isrchc_("-x", &c__24, clkeys, (ftnlen)2, (ftnlen)32);
	if (clflag[(i__1 = i__ - 1) < 24 && 0 <= i__1 ? i__1 : s_rnge("clflag"
		, i__1, "chwcml_", (ftnlen)3127)]) {
	    s_copy(aunits, clvals + (((i__1 = i__ - 1) < 24 && 0 <= i__1 ? 
		    i__1 : s_rnge("clvals", i__1, "chwcml_", (ftnlen)3129)) <<
