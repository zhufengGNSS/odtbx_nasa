...
/* Main program */ MAIN__(void)
{
    ...
    static char hlline[5120], kernam[1024*2];
    static integer infcnt;
    static char infmsg[1024*32];
    static logical sample;
    static char kernls[1024*3], gapstr[1024], timfmt[1024], tfrnam[32*2], 
	    diftyp[32], aunits[32];
    static doublereal cmpwin[1000006], av1[3000000]	/* was [3][1000000] */
	    ;
    static char stpstr[1024];
    static doublereal av2[3000000]	/* was [3][1000000] */, winmes;
    static integer myscid, sgtcnt, nsgcnt;
    static logical infprt[32], eponly;
    ...
    extern /* Subroutine */ int errprt_(char *, char *, ftnlen, ftnlen), 
	    ...
	    *, char *, char *, integer *, integer *, char *, ftnlen, ftnlen, 
	    ftnlen, ftnlen, ftnlen, ftnlen, ftnlen, ftnlen), wnfetd_(
	    doublereal *, integer *, doublereal *, doublereal *), setmsg_(
	    char *, ftnlen), sigerr_(char *, ftnlen), ldklst_(char *, ftnlen),
	     getqav_(logical *, char *, char *, doublereal *, integer *, 
	    logical *, doublereal *, doublereal *, logical *, char *, ftnlen, 
	    ftnlen, ftnlen), prefix_(char *, integer *, char *, ftnlen, 
	    ftnlen), suffix_(char *, integer *, char *, ftnlen, ftnlen), 
	    tostdo_(char *, ftnlen), rtdiff_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     char *, logical *, logical *, char *, integer *, integer *, char 
	    *, logical *, ftnlen, ftnlen, ftnlen), chkout_(char *, ftnlen);
...
/*     routine to get back all needed setups. */
    ...
    chwcml_(line, kernam, ffrnam, ffrid, tfrnam, tfrid, &avflg, &avfflg, 
	    ...
	    aunits, (ftnlen)1024, (ftnlen)1024, (ftnlen)32, (ftnlen)32, (
	    ftnlen)32, (ftnlen)1024, (ftnlen)1024, (ftnlen)32);
...
/*     window contains and get the measure of the window. */
	...
	winmes += cmpwin[(i__2 = i__ + 6) < 1000006 && 0 <= i__2 ? i__2 : 
		s_rnge("cmpwin", i__2, "frmdiff_", (ftnlen)243)] - cmpwin[(
		i__3 = i__ + 5) < 1000006 && 0 <= i__3 ? i__3 : s_rnge("cmpw"
		"in", i__3, "frmdiff_", (ftnlen)243)];
	if (cmpwin[(i__2 = i__ + 6) < 1000006 && 0 <= i__2 ? i__2 : s_rnge(
		"cmpwin", i__2, "frmdiff_", (ftnlen)245)] == cmpwin[(i__3 = 
		i__ + 5) < 1000006 && 0 <= i__3 ? i__3 : s_rnge("cmpwin", 
		i__3, "frmdiff_", (ftnlen)245)]) {
	    ++sgtcnt;
	} else {
	    ++nsgcnt;
	}
...
/*        Add one step for start of the interval. */
	...
	if (nitr + 1 <= 1000000) {
	    ...
	    epoch[(i__2 = nitr - 1) < 1000000 && 0 <= i__2 ? i__2 : s_rnge(
		    "epoch", i__2, "frmdiff_", (ftnlen)323)] = et[0];
	} else {
...
/*        of the interval minus padding. */
	...
	while(hdp1 < hdp2 && nitr < 1000000) {
	    ++nitr;
	    epoch[(i__2 = nitr - 1) < 1000000 && 0 <= i__2 ? i__2 : s_rnge(
		    "epoch", i__2, "frmdiff_", (ftnlen)342)] = hdp1;
	    ++count;
	    hdp1 = et[0] + step * count;
	}
...
/*        add one step for the end of the interval. */
	...
	if (et[0] != et[1]) {
		...
		epoch[(i__2 = nitr - 1) < 1000000 && 0 <= i__2 ? i__2 : 
			s_rnge("epoch", i__2, "frmdiff_", (ftnlen)357)] = et[
			1];
	    } else {
		setmsg_("There is a bug in the program. Please, contact NAIF."
			, (ftnlen)52);
...
/* Writing concatenation */
	    i__4[0] = 1024, a__1[0] = kernls + 2048;
	    i__4[1] = 1, a__1[1] = " ";
	    ...
	    getqav_(&c_true, ffrnam, tfrnam, epoch, &nitr, &avflg, q1, av1, &
		    ok, error, (ftnlen)32, (ftnlen)32, (ftnlen)1024);
		...
		errch_("#", error, (ftnlen)1, (ftnlen)1024);
...
/*           Set second attitude to identity and AV to zero. */
		...
		q2[(i__2 = (i__ << 2) - 4) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)444)] = 1.;
		q2[(i__2 = (i__ << 2) - 3) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)445)] = 0.;
		q2[(i__2 = (i__ << 2) - 2) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)446)] = 0.;
		q2[(i__2 = (i__ << 2) - 1) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)447)] = 0.;
		av2[(i__2 = i__ * 3 - 3) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)448)] = 0.;
		av2[(i__2 = i__ * 3 - 2) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)449)] = 0.;
		av2[(i__2 = i__ * 3 - 1) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)450)] = 0.;
	    }
	} else {
...
/* Writing concatenation */
	    ...
	    getqav_(&c_true, ffrnam + 32, tfrnam + 32, epoch, &nitr, &avflg, 
		    q2, av2, &ok, error, (ftnlen)32, (ftnlen)32, (ftnlen)1024)
		    ;
...
/*           Set second attitude to identity and AV to zero. */
	    ...
	    for (i__ = 1; i__ <= i__1; ++i__) {
		q2[(i__2 = (i__ << 2) - 4) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)625)] = 1.;
		q2[(i__2 = (i__ << 2) - 3) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)626)] = 0.;
		q2[(i__2 = (i__ << 2) - 2) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)627)] = 0.;
		q2[(i__2 = (i__ << 2) - 1) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)628)] = 0.;
		av2[(i__2 = i__ * 3 - 3) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)629)] = 0.;
		av2[(i__2 = i__ * 3 - 2) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)630)] = 0.;
		av2[(i__2 = i__ * 3 - 1) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)631)] = 0.;
	    }
	} else {
...
/*           Set second attitude to identity. */
	    ...
	    for (i__ = 1; i__ <= i__1; ++i__) {
		q2[(i__2 = (i__ << 2) - 4) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)782)] = 1.;
		q2[(i__2 = (i__ << 2) - 3) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)783)] = 0.;
		q2[(i__2 = (i__ << 2) - 2) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)784)] = 0.;
		q2[(i__2 = (i__ << 2) - 1) < 4000000 && 0 <= i__2 ? i__2 : 
			s_rnge("q2", i__2, "frmdiff_", (ftnlen)785)] = 0.;
		av2[(i__2 = i__ * 3 - 3) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)786)] = 0.;
		av2[(i__2 = i__ * 3 - 2) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)787)] = 0.;
		av2[(i__2 = i__ * 3 - 1) < 3000000 && 0 <= i__2 ? i__2 : 
			s_rnge("av2", i__2, "frmdiff_", (ftnlen)788)] = 0.;
	    }
	} else {
...
/*     before processing begin and end time command line arguments. */
	...
	if (sclkid[0] != 0) {
/* Writing concatenation */
	    i__5[0] = 1024, a__2[0] = kernls + 2048;
	    i__5[1] = 1, a__2[1] = " ";
	    i__5[2] = 1024, a__2[2] = kernls;
	    i__5[3] = 1, a__2[3] = " ";
...
/* Writing concatenation */
	    i__5[0] = 1024, a__2[0] = kernls + 2048;
	    i__5[1] = 1, a__2[1] = " ";
	    i__5[2] = 1024, a__2[2] = kernls + 1024;
	    i__5[3] = 1, a__2[3] = " ";
...
/* Writing concatenation */
	i__6[0] = 1024, a__3[0] = kernls + 2048;
	i__6[1] = 1, a__3[1] = " ";
	i__6[2] = 1024, a__3[2] = kernls + 1024;
	i__6[3] = 1, a__3[3] = " ";
	i__6[4] = 1024, a__3[4] = kernam + 1024;
	i__6[5] = 1, a__3[5] = " ";
	i__6[6] = 1024, a__3[6] = kernls;
	i__6[7] = 1, a__3[7] = " ";
...
/*     Make strings representing start and stop times. */
    ...
    etcal_(&cmpwin[(i__1 = cardd_(cmpwin) + 5) < 1000006 && 0 <= i__1 ? i__1 :
	     s_rnge("cmpwin", i__1, "frmdiff_", (ftnlen)914)], time + 1024, (
	    ftnlen)1024);
    ...
    repmf_(time + 1024, "#", &cmpwin[(i__1 = cardd_(cmpwin) + 5) < 1000006 && 
	    0 <= i__1 ? i__1 : s_rnge("cmpwin", i__1, "frmdiff_", (ftnlen)923)
...
/*        Tag all lines as printable. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    infprt[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("infprt"
		    , i__2, "frmdiff_", (ftnlen)986)] = TRUE_;
	}
...
/*        Tag all lines as printable. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    infprt[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("infprt"
		    , i__2, "frmdiff_", (ftnlen)1107)] = TRUE_;
	}
...
/*     Display report header. */
	...
	if (infprt[(i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : s_rnge("infprt"
		, i__2, "frmdiff_", (ftnlen)1275)]) {
	    tostdo_(infmsg + (((i__2 = i__ - 1) < 32 && 0 <= i__2 ? i__2 : 
		    s_rnge("infmsg", i__2, "frmdiff_", (ftnlen)1276)) << 10), 
		    (ftnlen)1024);
	}
    }
...
/*     the screen. */
    ...
    rtdiff_(q1, av1, q2, av2, cmpwin, &nitr, epoch, diftyp, &avflg, &avfflg, 
	    timfmt, &myscid, axes, aunits, &sample, (ftnlen)32, (ftnlen)1024, 
	    (ftnlen)32);
