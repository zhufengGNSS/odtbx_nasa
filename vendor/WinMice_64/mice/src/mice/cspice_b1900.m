%-Abstract
%
%   CSPICE_B1900 returns the double precision value of the Julian Date
...
%   returns:
%   
%     A double precision scalar, 2415020.31352, the Julian Date 
%     corresponding to Besselian Date 1900.0.
%   
%-Examples
%
...
function [b1900] = cspice_b1900
   ...
   switch nargin
      ...
      otherwise
         ...
         error ( 'Usage: double = cspice_b1900' )
