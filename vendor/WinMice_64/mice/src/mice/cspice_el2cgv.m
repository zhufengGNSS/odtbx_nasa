%-Abstract
%
%   CSPICE_EL2CGV converts a Mice ellipse to a center vector and two generating 
%   vectors. The selected generating vectors are semi-axes of the ellipse. 
%   
%-Disclaimer
%
...
%   Given:
%
%      ellipse   a structure describing a Mice ellipse. The structure has
%                the fields:
%
%                      center: [3x1 double]
...
%   returns:
%
%      center     double precision 3x1 array  defining the center 
%                 of 'ellipse'
%
