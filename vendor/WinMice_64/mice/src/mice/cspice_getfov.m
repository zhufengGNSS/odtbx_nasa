...
%   Given:
%
%      instid   {SCALAR, INTEGER}, NAIF ID for the instrument of 
%               interest.
%
%      room     {SCALAR, INTEGER}, the max number of double precision 
%               'bounds' vectors to return.
%
%   the call:
%
...
%   returns:
%
%      shape    {SCALAR, STRING}, the FOV shape for instrument 'instid'.
%               Possible values:
%   
%                    "POLYGON"
%                    "RECTANGLE"
...
%                    "ELLIPSE" 
%   
%      frame    {SCALAR, STRING}, the name of the frame in which the FOV is
%               defined.
%
%      bsight   {3x1 ARRAY, DOUBLE PRECISION}, the vector pointing in the
%               direction of the FOV center (boresight).
%
%      bounds   {3xN ARRAY, DOUBLE PRECISION}, set of vectors pointing to
%               the "corners" of the instrument FOV, i.e. 'bounds' returns 
%               as a N columns of 3-vectors.
%
