...
%
%      left, 
%      right    the double precision scalar values defining the left 
%               and right endpoints of the complement interval
%
...
%   returns:
%
%      result   the double precision Nx1 array serving as the Mice version
%               of a SPICE window, containing the complement of 'window'
%               with respect to the interval 'left' to 'right'
%
%-Examples
%
