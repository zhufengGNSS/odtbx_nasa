...
%                 interval to insert
%
%      window_i   an optional input describing a double precision 
%                 Mx1 array serving as the Mice version of a SPICE window,
%                 containing zero or more intervals. Inclusion of this
%                 window argument results in an output window consisting
%                 of a union of the data in 'window_i' and the window 
%                 defined as [left,right].
%
%   the call:
%
...
%   returns:
%
%      window  the double precision Nx1 array consisting
%              of either the interval [left,right] or the window
%              union of 'window_i' and [left,right]
%
%-Examples
%
