%-Abstract
%
%   ZZMICE_ELL enforces a structure as a Mice ellipse.
%
%-Disclaimer
%
...
%   Given:
%
%      x   a scalar or vector of structures representing a Mice ellipse(s)
%
%   the call:
%
%      y = zzmice_ell(x)
...
%          field types, and field dimensions of a Mice ellipse
%
%-Examples
%
%   None.
